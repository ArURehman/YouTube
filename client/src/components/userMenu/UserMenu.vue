<template>
    <div class="text-xs text-white absolute right-8 top-8 w-[12rem] h-[11.6rem] bg-searchBarGray rounded-xl z-10 px-[1px]">
        <div class="flex">
        ...
        <div class="bg-almostBlack w-full h-[79%]">
            ...
            <button class=" my-1 bg-almostBlack w-full h-9 px-3 py-1 hover:bg-gray hover:rounded-sm cursor-pointer flex justify-start ease-in-out duration-200">
                <font-awesome-icon class="mt-2 ml-1" icon="fa-solid fa-trash-can" size="xs" style="color: #ff0000;" /><span class="mx-3 mt-[6px] text-[#ff0000]">Delete Account</span>
            </button>
        </div>
    </div>
</template>
